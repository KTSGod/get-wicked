...
<html lang="en" >
  ...
  <a class="menu-link is-active" href="#">Tools</a>
  <a class="menu-link notify" href="#">Status</a>
  <a class="menu-link" href="#">Discover</a>
  <a class="menu-link notify" href="#">Subscription</a>
  </div>
  ...
  <img class="profile-img" src="https://as1.ftcdn.net/v2/jpg/03/76/74/78/1000_F_376747823_L8il80K6c2CM1lnPYJhhJZQNl6ynX1yj.jpg" alt="">
  </div>
  </div>
  <div class="wrapper">
  <div class="left-side">
  ...
  <div class="content-text">30-day free trial plan for our tools! Note: After the trial expires your account will be deleted within 30 days after the purchase!</div>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script><script  src="./scripts/main.js"></script>
